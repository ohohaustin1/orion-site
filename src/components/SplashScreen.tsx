...
export function SplashScreen({ onComplete }: SplashScreenProps) {
  ...
  return (
    <div className="splash-v2" role="status" aria-live="polite" aria-label="Orion AI 追蹤系統初始化中">
      ...
      <div className="splash-stage">
        ...
        <div className="brand-tagline">把每天追人的事交給 O</div>
